...
TOL<- read.csv("Data_outB Tolima .csv")
ANT<- read.csv("Data_outB Antioquia .csv")
ARA<- read.csv("Data_outB Arauca .csv")
BOL<- read.csv("Data_outB Bolivar .csv")
BOY<- read.csv("Data_outB Boyaca .csv")
CAS<- read.csv("Data_outB Casanare .csv")
CES<- read.csv("Data_outB Cesar .csv")
CUN<- read.csv("Data_outB Cundinamarca .csv")
GUA<- read.csv("Data_outB Guainia .csv")
MAG<- read.csv("Data_outB Magdalena .csv")
MET<- read.csv("Data_outB Meta .csv")
NST<- read.csv("Data_outB NorteSantander .csv")
SAN<- read.csv("Data_outB Santander .csv")
SUC<- read.csv("Data_outB Sucre .csv")
SAP<- read.csv("Data_outB SanAndres .csv")
VAU<- read.csv("Data_outB Vaupes .csv")
NAR<- read.csv("Data_outB Narino .csv")
QUI<- read.csv("Data_outB Quindio .csv")
CAU<- read.csv("Data_outB Cauca .csv")
VLL<- read.csv("Data_outB Valle .csv")
PUT<- read.csv("Data_outB Putumayo .csv")
COR<- read.csv("Data_outB Cordoba .csv")
RIS<- read.csv("Data_outB Risaralda .csv")
VIC<- read.csv("Data_outB Vichada .csv")
ATL<- read.csv("Data_outB Atlantico .csv")
CAL<- read.csv("Data_outB Caldas .csv")
AMA<- read.csv("Data_outB Amazonas .csv")
GUJ<- read.csv("Data_outB Guajira .csv")
CHO<- read.csv("Data_outB Choco .csv")
CAQ<- read.csv("Data_outB Caqueta .csv")
GVR<- read.csv("Data_outB Guaviare .csv")
HUI<- read.csv("Data_outB Huila .csv")
BOG<- read.csv("Data_outB Bogota .csv")
...
write.csv(CASES, "TotalCases.csv")
...
TOLb<- read.csv("Data36yB Tolima .csv")
ANTb<- read.csv("Data36yB Antioquia .csv")
ARAb<- read.csv("Data36yB Arauca .csv")
BOLb<- read.csv("Data36yB Bolivar .csv")
BOYb<- read.csv("Data36yB Boyaca .csv")
CASb<- read.csv("Data36yB Casanare .csv")
CESb<- read.csv("Data36yB Cesar .csv")
CUNb<- read.csv("Data36yB Cundinamarca .csv")
GUAb<- read.csv("Data36yB Guainia .csv")
MAGb<- read.csv("Data36yB Magdalena .csv")
METb<- read.csv("Data36yB Meta .csv")
NSTb<- read.csv("Data36yB NorteSantander .csv")
SANb<- read.csv("Data36yB Santander .csv")
SUCb<- read.csv("Data36yB Sucre .csv")
SAPb<- read.csv("Data36yB SanAndres .csv")
VAUb<- read.csv("Data36yB Vaupes .csv")
NARb<- read.csv("Data36yB Narino .csv")
QUIb<- read.csv("Data36yB Quindio .csv")
CAUb<- read.csv("Data36yB Cauca .csv")
VLLb<- read.csv("Data36yB Valle .csv")
PUTb<- read.csv("Data36yB Putumayo .csv")
CORb<- read.csv("Data36yB Cordoba .csv")
RISb<- read.csv("Data36yB Risaralda .csv")
VICb<- read.csv("Data36yB Vichada .csv")
ATLb<- read.csv("Data36yB Atlantico .csv")
CALb<- read.csv("Data36yB Caldas .csv")
AMAb<- read.csv("Data36yB Amazonas .csv")
GUJb<- read.csv("Data36yB Guajira .csv")
CHOb<- read.csv("Data36yB Choco .csv")
CAQb<- read.csv("Data36yB Caqueta .csv")
GVRb<- read.csv("Data36yB Guaviare .csv")
HUIb<- read.csv("Data36yB Huila .csv")
BOGb<- read.csv("Data36yB Bogota .csv")
...
TOLc<- read.csv("Data_out36B Tolima .csv")
ANTc<- read.csv("Data_out36B Antioquia .csv")
ARAc<- read.csv("Data_out36B Arauca .csv")
BOLc<- read.csv("Data_out36B Bolivar .csv")
BOYc<- read.csv("Data_out36B Boyaca .csv")
CASc<- read.csv("Data_out36B Casanare .csv")
CESc<- read.csv("Data_out36B Cesar .csv")
CUNc<- read.csv("Data_out36B Cundinamarca .csv")
GUAc<- read.csv("Data_out36B Guainia .csv")
MAGc<- read.csv("Data_out36B Magdalena .csv")
METc<- read.csv("Data_out36B Meta .csv")
NSTc<- read.csv("Data_out36B NorteSantander .csv")
SANc<- read.csv("Data_out36B Santander .csv")
SUCc<- read.csv("Data_out36B Sucre .csv")
SAPc<- read.csv("Data_out36B SanAndres .csv")
VAUc<- read.csv("Data_out36B Vaupes .csv")
NARc<- read.csv("Data_out36B Narino .csv")
QUIc<- read.csv("Data_out36B Quindio .csv")
CAUc<- read.csv("Data_out36B Cauca .csv")
VLLc<- read.csv("Data_out36B Valle .csv")
PUTc<- read.csv("Data_out36B Putumayo .csv")
CORc<- read.csv("Data_out36B Cordoba .csv")
RISc<- read.csv("Data_out36B Risaralda .csv")
VICc<- read.csv("Data_out36B Vichada .csv")
ATLc<- read.csv("Data_out36B Atlantico .csv")
CALc<- read.csv("Data_out36B Caldas .csv")
AMAc<- read.csv("Data_out36B Amazonas .csv")
GUJc<- read.csv("Data_out36B Guajira .csv")
CHOc<- read.csv("Data_out36B Choco .csv")
CAQc<- read.csv("Data_out36B Caqueta .csv")
GVRc<- read.csv("Data_out36B Guaviare .csv")
HUIc<- read.csv("Data_out36B Huila .csv")
BOGc<- read.csv("Data_out36B Bogota .csv")
...
Median<- rbind( colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="Cases.Acute"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="Cases.Asymptomatic"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="Cases.ChronicMild"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="Cases.ChronicSevere"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="Deaths.Total"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="YLL"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Median" & COLc$metric=="YLD"),])[,5:40]))

Low<- rbind( colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="Cases.Acute"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="Cases.Asymptomatic"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="Cases.ChronicMild"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="Cases.ChronicSevere"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="Deaths.Total"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="YLL"),])[,5:40]),
                colSums((COLc[which(COLc$bound== "Low" & COLc$metric=="YLD"),])[,5:40]))


Upper<- rbind( colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="Cases.Acute"),])[,5:40]),
             colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="Cases.Asymptomatic"),])[,5:40]),
             colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="Cases.ChronicMild"),])[,5:40]),
             colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="Cases.ChronicSevere"),])[,5:40]),
             colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="Deaths.Total"),])[,5:40]),
             colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="YLL"),])[,5:40]),
             colSums((COLc[which(COLc$bound== "Upper" & COLc$metric=="YLD"),])[,5:40]))

SuperTotal36<- data.frame(cbind(rbind(Median, Low, Upper), 
                     c(rep("Median",7), rep("Low", 7), rep("Upper", 7)),
                     rep(c("Cases.Acute", "Cases.Asymptomatic", "Cases.ChronicMild", "Cases.ChronicSevere", "Deaths.Total", "YLL", "YLD"), 3)))

write.csv(SuperTotal36, "SuperTotal36.csv")
...
cols <- c("black","red")
pos <- (P[,1]) >= 0
barplot((P[,1]), col = cols[pos + 1], border = cols[pos + 1], xlim=c(-.3,.8), horiz=T,
        names=letters, main=".", las=2, xlab="PRCC")
data.frame(cbind(names(dat), P))
...
cols <- c("black","red")
pos <- (P[,1]) >= 0
barplot((P[,1]), col = cols[pos + 1], border = cols[pos + 1], xlim=c(-.1,.8), horiz=T,
        names=letters, main="B", las=2, xlab="PRCC")
